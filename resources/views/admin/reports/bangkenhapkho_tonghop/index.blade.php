...
$('#loai_bao_cao_ten').change(function(){
        ...
        } else if($('#loai_bao_cao_ten').val() == 'nguon_von'){
    ...
    function disabling_control(nguoncungcap, sanpham, nhomsanpham, loaisanpham){
        $('#p_nguoncungcap_id').attr('disabled', nguoncungcap) ;
